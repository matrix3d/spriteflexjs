...
package com.hsharma.hungryHero.screens
{
	...
	public class InGame extends Sprite
	{
		...
		private function drawGame():void
		{
			...
			{
				particleCoffee = new PDParticleSystem(Assets.assets["particles/particleCoffee.json"],Assets.assets["particles/texture.png"]);
				...
				particleMushroom = new PDParticleSystem(Assets.assets["particles/particleMushroom.json"],Assets.assets["particles/texture.png"]);
					...
					else
					{
						...
						if (heroItem_sqDist < 5000)
						{
							...
							if (itemToTrack.foodItemType <= com.hsharma.hungryHero.GameConstants.ITEM_TYPE_5)
							{
								...
								if (!com.hsharma.hungryHero.Sounds.muted) com.hsharma.hungryHero.Sounds.sndEat.play();
							}
			...
			if (!gamePaused)
			{
				...
				for (var i:uint = 0; i < obstaclesToAnimateLength ; i ++)
				{
					...
					if (heroObstacle_sqDist < 5000 && !obstacleToTrack.alreadyHit)
					{
						...
						if (!com.hsharma.hungryHero.Sounds.muted) com.hsharma.hungryHero.Sounds.sndHit.play();
						...
						else 
						{
							...
							// Play hurt sound.
							if (!com.hsharma.hungryHero.Sounds.muted) com.hsharma.hungryHero.Sounds.sndHurt.play();
