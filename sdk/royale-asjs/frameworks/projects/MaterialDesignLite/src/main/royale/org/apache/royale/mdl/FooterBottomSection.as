...
package org.apache.royale.mdl
{
	...
	/**
	 *  The FooterBottomSection class is a footer bottom container section capable
	...
	public class FooterBottomSection extends Group implements IFooterSection
	{
		 ...
		 *  @productversion Royale 0.8
		 */
		public function FooterBottomSection()
		{
			super();
        ...
        */
		...
		override public function addedToParent():void
        {
			...
			{
				throw new Error("FooterBottomSection can not be used if parent is not a MDL Footer component.");
			}
        }
	}
}
