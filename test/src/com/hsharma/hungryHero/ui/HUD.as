...
package com.hsharma.hungryHero.ui
{
	...
	public class HUD extends Sprite
	{
		...
		private function onAddedToStage(event:Event):void
		{
			...
			// Lives label
			livesLabel = new StarlingTextField(150, 20, "L I V E S", fontScoreLabel.fontName, fontScoreLabel.fontSize, 0xffffff);
			...
			// Lives
			livesText = new StarlingTextField(150, 75, "5", fontScoreValue.fontName, fontScoreValue.fontSize, 0xffffff);
			...
			// Distance label
			distanceLabel = new StarlingTextField(150, 20, "D I S T A N C E", fontScoreLabel.fontName, fontScoreLabel.fontSize, 0xffffff);
			...
			// Distance
			distanceText = new StarlingTextField(150, 75, "0", fontScoreValue.fontName, fontScoreValue.fontSize, 0xffffff);
			...
			// Score label
			foodScoreLabel = new StarlingTextField(150, 20, "S C O R E", fontScoreLabel.fontName, fontScoreLabel.fontSize, 0xffffff);
			...
			// Score
			foodScoreText = new StarlingTextField(150, 75, "0", fontScoreValue.fontName, fontScoreValue.fontSize, 0xffffff);
